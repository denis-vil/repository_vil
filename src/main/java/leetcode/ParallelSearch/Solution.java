...
public class Solution {
    ...
    public boolean search(int searchNumber, int witch, int before) {
        for (int i = witch; i <= before; i++) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        solution.search(255,0,400);
        System.out.println(System.currentTimeMillis() - from1);


        Thread thread1 = new Thread(new Runnable() {
            @Override
            public void run() {
                solution.search(255, 0, 199);
            }
        });
        Thread thread2 = new Thread(new Runnable() {
            @Override
            public void run() {
                solution.search(255, 200, 400);
            }
        });
